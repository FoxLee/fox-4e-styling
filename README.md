...
* I haven't worked out how to include selectable styles yet, but you can access the boxed text style by switching to the code editor and wrapping the target content in a div with the "rules-block" class.
...
* If you have "Colour Powers By Use Type" turned on, this module tweaks the colours to be a bit more book-accurate (matching chat cards and PC sheet).
* Not currently optional. I want to put this in a new journal sheet or make it a toggle-able setting, but I haven't worked that out yet!
### To-Do/In Progress
